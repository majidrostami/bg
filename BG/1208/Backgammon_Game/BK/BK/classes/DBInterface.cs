...
namespace BK
{
    public class DBInterface
    {
        ...
        public static bool InsertGameRecord(string player1, string player2, short winner,bool abondoned, int p1Doubles, int p2Doubles, int p1Pips, int p2Pips, int pipsatEnd , DateTime startTime , DateTime endTime, int nRolls)
        {
            string storedProcedure = "insertGameRecord";
            List<Param> myParams = new List<Param>();
            myParams.Add(new Param("@player1", player1, SqlDbType.VarChar, 100));
            myParams.Add(new Param("@player2", player2, SqlDbType.VarChar, 100));
            myParams.Add(new Param("@winner", winner, SqlDbType.SmallInt));
            myParams.Add(new Param("@abondoned", abondoned, SqlDbType.Bit));
            myParams.Add(new Param("@p1Doubles", p1Doubles, SqlDbType.Int));
            myParams.Add(new Param("@p2Doubles", p2Doubles, SqlDbType.Int));
            myParams.Add(new Param("@p1Pips", p1Pips, SqlDbType.Int));
            myParams.Add(new Param("@p2Pips", p2Pips, SqlDbType.Int));
            myParams.Add(new Param("@pipsAtend", pipsatEnd, SqlDbType.Int));
            myParams.Add(new Param("@startTime", startTime, SqlDbType.DateTime));
            myParams.Add(new Param("@endTime", endTime, SqlDbType.DateTime));
            myParams.Add(new Param("@nRolls", nRolls, SqlDbType.Int));

            try
            {
                bool sucess = updateDB(storedProcedure, myParams);
                return sucess; 
            }
            catch
            {
        ...
        public static DataSet accessDB(string storedProcedure, List<Param> myParam)
        {
            ...
            try
            {
                ...
                connection = new SqlConnection("Data Source=majidrostami.db.5365474.hostedresource.com;Initial Catalog=majidrostami;User ID=majidrostami;Password=irMast88");
                connection.Open();
